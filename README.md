...
```text
├── backend/            FastAPI app — parsers, normalizer, detection rules, AI investigator
...
├── js/                 One JavaScript module per screen
├── index.html          The web interface
├── styles.css          Design system (light and dark themes)
├── samples/            Demo log files for judges and testers
├── scripts/            One-time download tools (IP database, world map)
├── Dockerfile · docker-compose.yml
└── server/             Earlier Node.js prototype (not used)
```
